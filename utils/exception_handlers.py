...
from utils.exception import integrity_error_handler,http_exception_handler,sqlalchemy_error_handler,general_exception_handler


def register_exception_handlers(app):
    """
    注册全局异常处理 子类在前 父类灾后，具体在前 抽象在后
    """
